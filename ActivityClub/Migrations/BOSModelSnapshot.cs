...
namespace ActivityClub.Migrations
{
    ...
    partial class BOSModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ActivityClub.Models.Event", b =>
                {
                    ...
                    b.Property<int>("CategoryLookupID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ActivityClub.Models.Event", b =>
                {
                    ...
                    b.HasOne("ActivityClub.Models.Lookup", null)
                        .WithMany("Events")
            ...
            modelBuilder.Entity("EventGuides", b =>
                {
                    ...
                    b.HasOne("ActivityClub.Models.User", null)
                        .WithMany("EventGuides")
